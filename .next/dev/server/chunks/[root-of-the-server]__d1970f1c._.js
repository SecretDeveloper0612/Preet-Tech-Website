...
const googleSheetsService = {
    ...
    addLeadToSpecificSheet: async (sheetName, data)=>{
        try {
            const auth = getGoogleSheetsAuth();
            const sheets = __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$node_modules$2f$googleapis$2f$build$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["google"].sheets({
                version: 'v4',
            ...
            try {
                ...
                const tabExists = sheetMeta.data.sheets?.some((s)=>s.properties?.title === sheetName);
                if (!tabExists) {
                    // Add the sheet tab
...
"[project]/preet-tech-next-gen-digital-agency 2/lib/eco-portfolio.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$eco$2d$portfolio$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/preet-tech-next-gen-digital-agency 2/lib/eco-portfolio.ts [app-route] (ecmascript)");
;
;
...
const emailService = {
    ...
    sendEcoLeadThankYouEmail: async (lead)=>{
        ...
        try {
            ...
            const industrySample = __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$eco$2d$portfolio$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["portfolioItems"].find((item)=>item.category.toLowerCase() === (lead.industry || '').toLowerCase() && item.link !== '#');
            // Sanitized App URL for links
            const baseUrl = (("TURBOPACK compile-time value", "http://localhost:3000/") || 'https://preettech.com').replace(/\/$/, '');
            // Email clients cannot load localhost images. Force production domain or public fallback for the logo.
            const publicLogoUrl = baseUrl.includes('localhost') ? 'https://preettech.com/logo-preet-tech.png' : `${baseUrl}/logo-preet-tech.png`;
...
"[project]/preet-tech-next-gen-digital-agency 2/app/api/leads/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$validateEmail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateEmail"])(email)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        if (leadData.service === 'App Development') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$googleSheetsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["googleSheetsService"].addAppLead(leadData);
        } else if (leadData.service === 'Software Development') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$googleSheetsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["googleSheetsService"].addSoftwareLead(leadData);
        } else if (leadData.service === 'Performance Marketing') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$googleSheetsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["googleSheetsService"].addMarketingLead(leadData);
        } else if (leadData.service === 'Advance Website') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$googleSheetsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["googleSheetsService"].addAdvanceWebsiteLead(leadData);
        } else if (leadData.service === 'Social Media Handling') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$googleSheetsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["googleSheetsService"].addSocialMediaLead(leadData);
        } else if (leadData.service === 'Partnership Marketing') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$googleSheetsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["googleSheetsService"].addPartnershipMarketingLead(leadData);
        } else if (leadData.service === 'Content Creation') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$googleSheetsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["googleSheetsService"].addContentCreationLead(leadData);
        } else if (leadData.service === 'Start Business') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$preet$2d$tech$2d$next$2d$gen$2d$digital$2d$agency__2$2f$lib$2f$googleSheetsService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["googleSheetsService"].addStartBusinessLead(leadData);
        } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d1970f1c._.js.map