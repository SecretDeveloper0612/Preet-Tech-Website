        ...
        <section className="py-24 px-6 bg-white dark:bg-[#030712] relative scroll-reveal">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-20">
                    <span className="text-brand-cyan text-[10px] font-black uppercase tracking-[0.4em] mb-4 block">Engineered for Success</span>
                    <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white uppercase tracking-tight">
                        Why Choose <span className="text-brand-cyan italic">Preet Tech?</span>
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {FEATURES.map((item, i) => (
                        ...
                        >
                            <div className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-brand-cyan group-hover:shadow-[0_0_30px_rgba(95,211,230,0.3)] transition-all">
                                <item.icon className="w-6 h-6 text-brand-medium dark:text-brand-cyan group-hover:text-[#030712] transition-colors" />
                            </div>
                            <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight mb-3 group-hover:text-brand-cyan transition-colors">{item.title}</h3>
